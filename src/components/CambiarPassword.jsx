...
const CambiarPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (password.pwd_nuevo.length < 6) {
      setAlerta({
        msg: 'El nuevo password debe ser al menos de 6 caracteres', 
        error: true
      })
      return
    }
        ...
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
          ...
          <form
            ...
            <input
              ...
              className="bg-indigo-700 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-full"
            />
          </form>
        </div>
      </div>
