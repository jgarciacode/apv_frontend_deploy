...
const Registrar = () => {
    ...
    const handleSubmit = async e => {
        ...
        if (password !== repetirPassword) {
            setAlerta({ msg: 'La contraseña debe ser la misma en ambos campos', error: true })
            return
        }
        if (password.length < 5) {
            setAlerta({ msg: 'La contraseña debe ser de mínimo 5 caracteres', error: true })
            return
        }
    ...
    return (
        <>
            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
                ...
                >
                    <div className='my-5'>
                        <label className='uppercase text-gray-600 block text-xl '>
                            Nombre
                        </label>
                        <input
                            type="text"
